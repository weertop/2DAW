<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="EjercicioFechaPropuesto.aspx.cs" Inherits="EjercicioFechaPropuesto" %>


<!--EnableEventValidation="false" se pone para evitar que salte el error al modificar la lista-->
                ...
                <ContentTemplate>
                    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="-1">
                        ...
                        <asp:View ID="View2" runat="server">
                            ...
                            <br />
                            <asp:ListBox ID="ListBox1" runat="server" Width="351px" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged"></asp:ListBox>
                            <br />
                            <asp:Label ID="Label13" runat="server" Text="Borrado:"></asp:Label>
                        ...
                        <asp:View ID="View3" runat="server">
                            ...
                            <br />
                            <asp:ListBox ID="ListBox2" runat="server" OnSelectedIndexChanged="ListBox2_SelectedIndexChanged" Width="352px"></asp:ListBox>
                            <br />
