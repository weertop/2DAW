...
<body>
    ...
    <div>
        ...
        <asp:Menu ID="Menu1" runat="server" OnMenuItemClick="Menu1_MenuItemClick" Orientation="Horizontal" Height="50px" RenderingMode="Table" Width="1000px">
            <Items>
                <asp:MenuItem Text="INTRODUCIR_ DATOS" Value="INTRODUCIR_ DATOS" ToolTip="Tienes que introducir los datos">
                    <asp:MenuItem Text="Mas Datos" Value="MAS"></asp:MenuItem>
                </asp:MenuItem>
                <asp:MenuItem Text="MOSTRAR_ INFORMACIÓN" Value="MOSTRAR"></asp:MenuItem>
